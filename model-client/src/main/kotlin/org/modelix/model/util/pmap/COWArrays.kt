...
object COWArrays {
    fun <T> insert(array: Array<T>, index: Int, element: T): Array<T> {
        val newArray = java.lang.reflect.Array.newInstance(array.javaClass.getComponentType(), array!!.size + 1) as Array<T>
    ...
    fun <T> add(array: Array<T>, value: T): Array<T> {
        val newArray: Array<T> = Arrays.copyOf(array, array!!.size + 1)
