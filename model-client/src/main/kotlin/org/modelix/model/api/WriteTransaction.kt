...
class WriteTransaction(override var tree: ITree, branch: IBranch, idGenerator: IIdGenerator?) : Transaction(branch), IWriteTransaction {
    //protected override var tree: ITree?
...
//    }
    ...
    // TODO we should add this check
//    fun setTree(newTree: ITree) {
//        checkNotClosed()
//        tree = newTree
//    }
